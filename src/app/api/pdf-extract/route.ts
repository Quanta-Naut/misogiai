...
export async function POST(request: NextRequest) {
  try {
    ...
    try {
      ...
      console.log(`Buffer created: ${buffer.length} bytes`)      // Extract text from PDF with valid options
      ...
      const fallbackText = `[PDF Content Placeholder - ${file.name}]
      
This is a placeholder for PDF content extraction from file: ${file.name}

The actual PDF text extraction is temporarily using a fallback method due to library compatibility.
